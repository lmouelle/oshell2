...
and if_clause_test = { test : compound_list; body : compound_list }

and compound_command =
  | CompoundCommandIf of {
      ifelse : compound_list option;
      tests : if_clause_test list;
    }
...
and pipeline = PipelineBangSeq of pipe_sequence | PipelineSeq of pipe_sequence
